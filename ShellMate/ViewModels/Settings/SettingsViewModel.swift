  ...
  init() {
      ...
      let position = WindowAttachmentPosition(rawValue: savedPosition)
    {
      ...
      UserDefaults.standard.set(
        self.windowAttachmentPosition.rawValue, forKey: "windowAttachmentPosition")
    }
    // Add the observer
    NotificationCenter.default.addObserver(
      self, selector: #selector(handleWindowAttachmentPositionDidChange(_:)),
      name: .windowAttachmentPositionDidChange, object: nil)
  }
